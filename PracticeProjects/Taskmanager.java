...
public class Taskmanager {
    ...
    public static void compareSortingalgorithms() {
        /**
         * comapres the speed of my InsertSort algorithm and my Implementation of a
    ...
    public static double testInsertSortingalgorithms(String[] strings) {
        ...
        current = System.nanoTime();
        String[] sortedString6 = Sort.MergeSortLinkedII(strings.clone(),
                "PracticeProjects/Textfiles/CharacterOrder.txt"); // <--calling
        // the
        // Algorithm
    ...
    public static void testradixalgorithms(String[] strings, double t1) {
         ...
         * current = System.nanoTime();
         * String[] sortedString2 = Sort.radixInsertSort(str2,
         * "PracticeProjects/Textfiles/CharacterOrder.txt", .99d);
         * double t2 = (System.nanoTime() - current) * Math.pow(10, -6);
         * 
         ...
         * 
         * Filemanager.createFile(
         * "PracticeProjects/Textfiles/sortedTextoutputfiles/Sortiert2.txt", true);
         * Filemanager.writeToFile(
         * "PracticeProjects/Textfiles/sortedTextoutputfiles/Sortiert2.txt",
         * sortedString2, true);
