...
public class SigmaSum {
    ...
    public static double sum(String methodName, int start, int end, Double[] params) throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
    ...
    public static double SigmaCalc(Object object, Method method, int start, int end, Double[] params) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException{
        double sum = 0;
